...
def _strategy_semantic_first(self, query: str):
    ...
    subgraph = self.expand_by_graph(entities, hops=2)

    # 4. Combinar y rankear
    return self.hybrid_ranking(chunks, subgraph)
```
...
def _strategy_graph_first(self, query: str):
    ...
    # 2. Cypher query con filtros
    nodes = self.graph_search_filtered(filters)
    ...
    return self.rerank_by_similarity(query, chunks)
```
...
**Implementación:**
```python
def hybrid_ranking(self, vector_results: List, graph_results: List) -> List:
    candidates = {}
...
def _strategy_metapaths(self, query: str):
    ...
    # 3. Ejecutar path query
    paths = self.execute_metapath(entities, metapath)

    # 4. Adjuntar evidencia a cada path
    paths_with_evidence = self.attach_evidence_to_paths(paths)

    return paths_with_evidence
```
...
class GraphRAGAssistant:
    ...
    def expand_by_graph(self, entities: List[Dict], hops: int = 2) -> List[Dict]:
    ...
    def _strategy_semantic_first(self, query: str) -> List[Dict]:
        """Estrategia 1: Semántica → Grafo (exploratoria)"""
        # TODO: Implementar
        pass

    def _strategy_graph_first(self, query: str) -> List[Dict]:
        """Estrategia 2: Grafo → Semántica (filtrada)"""
        # TODO: Implementar
        pass

    def _strategy_metapaths(self, query: str) -> List[Dict]:
        """Estrategia 4: Entity linking + metapaths"""
        # TODO: Implementar
        pass

    def _strategy_communities(self, query: str) -> List[Dict]:
        """Estrategia 5: Comunidades + resúmenes"""
        # TODO: Implementar
        # Debe verificar primero si existen comunidades
        pass

    def _strategy_paths(self, query: str) -> List[Dict]:
        """Estrategia 6: Paths como evidencia"""
        # TODO: Implementar
        pass
    ...
    def ask(self, query: str) -> Dict:
        ...
        # 4-5. Aplicar estrategia según intención
        if intent == 'exploratoria':
            results = self._strategy_semantic_first(query)
        elif intent == 'filtrada':
            results = self._strategy_graph_first(query)
        elif intent == 'explicable':
            results = self._strategy_paths(query)
        elif intent == 'sintesis':
            results = self._strategy_communities(query)
        else:
            results = self.hybrid_ranking(vector_results, [])
