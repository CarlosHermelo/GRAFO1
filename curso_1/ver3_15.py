...
# ================================
# OPENAI CLIENT (TU VERSIÓN)
# ================================
client = OpenAI()   # <-- EXACTAMENTE como lo usabas antes
...
# ================================
# 4. INFERENCIA CONCEPTUAL (igual que 3_15)
# ================================
def infer_generic_type(entity_name: str, clusters: List[Cluster]):
    cluster_map = {c.cluster_name: c.members for c in clusters}

    system = """
Dada una entidad concreta, inferí el tipo conceptual general.
...
def extract_relations(text: str, normalized_entities):
    ...
    system = """
Extraé relaciones conceptuales entre entidades.
...
# 6. EXPORTAR A CYPHER
# ================================
def export_to_cypher(normalized_entities, relations, output="graph_import.cypher"):
    lines = []
    ...
    print(f"\nArchivo Cypher generado: {output}")
